...
import { SubCategoryCreateData } from "@/types/category";
...
export function AddSubcategoryDialog({
  ...
  const { addSubcategory, isCreating, createError } = useCategorys();
  const [open, setOpen] = useState(false);
  const form = useForm<SubCategoryCreateData>({
    defaultValues: {
      name: "",
      description: "",
  ...
  async function onSubmit(values: SubCategoryCreateData) {
    try {
